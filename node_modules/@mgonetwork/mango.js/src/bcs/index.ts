import type { EnumTypeDefinition, StructTypeDefinition } from '@mgonetwork/bcs';
import { BCS, getMgoMoveConfig } from '@mgonetwork/bcs';

import type { MgoObjectRef } from '../types/objects.js';
 ...
 * An object argument.
 */
export type ObjectArg = { ImmOrOwned: MgoObjectRef } | { Shared: SharedObjectRef };
...
/**
 * Mgo TypeTag object. A decoupled `0x...::module::Type<???>` parameter.
 */
export type TypeTag =
	| { bool: null }
	| { u8: null }
...
const BCS_SPEC: TypeSchema = {
	enums: {
		...
		TransactionKind: {
			// can not be called from mgo.js; dummy placement
...
const bcs = new BCS({ ...getMgoMoveConfig(), types: BCS_SPEC });
