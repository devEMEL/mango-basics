...
import { encodeMgoPrivateKey, Keypair, PRIVATE_KEY_SIZE } from '../../cryptography/keypair.js';
...
export const DEFAULT_ED25519_DERIVATION_PATH = "m/44'/938'/0'/0'/0'";
...
export class Ed25519Keypair extends Keypair {
	 ...
	 * the raw secret key.
	 *
	 * The mgo.keystore key is a list of Base64 encoded `flag || privkey`. To import
	 * a key from mgo.keystore to typescript, decode from base64 and remove the first
	 * flag byte after checking it is indeed the Ed25519 scheme flag 0x00
	 * * ```
	 * import { Ed25519Keypair, fromB64 } from '@mgonetwork/mango.js';
