...
import { encodeMgoPrivateKey, Keypair } from '../../cryptography/keypair.js';
...
export const DEFAULT_SECP256R1_DERIVATION_PATH = "m/74'/938'/0'/0/0";
...
export class Secp256r1Keypair extends Keypair {
	...
	static fromSecretKey(
		...
		if (!options || !options.skipValidation) {
			...
			const msgHash = bytesToHex(keccak_256(signData));
	 ...
	 */
	getSecretKey(): string {
		return encodeMgoPrivateKey(this.keypair.secretKey, this.getKeyScheme());
	}
