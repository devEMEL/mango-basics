import { toB58 } from '@mgonetwork/bcs';
...
const GasConfig = object({
	...
	payment: optional(array(MgoObjectRef)),
...
function prepareMgoAddress(address: string) {
	return normalizeMgoAddress(address).replace('0x', '');
}
