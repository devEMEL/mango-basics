import { BCS, fromB64 } from '@mgonetwork/bcs';
...
// crates/mgo-framework/packages/mgo-framework/sources/package.move
		...
		return create(
			{
				...
				dependencies: dependencies.map((dep) => normalizeMgoObjectId(dep)),
			},
			PublishTransaction,
		);
	},
