import type { TypeName } from '@mgonetwork/bcs';
import { BCS } from '@mgonetwork/bcs';
...
builder
	...
	// Keep this in sync with crates/mgo-types/src/messages.rs
...
builder.registerType(
	...
	function encodeProgrammableTx(this: BCS, writer, data: MoveCallTransaction, typeParams, typeMap) {
		...
		return this.getTypeInterface(PROGRAMMABLE_CALL_INNER)._encodeRaw.call(
			...
			writer,
			{
				package: normalizeMgoAddress(pkg),
				module,
				function: fun,
				type_arguments,
