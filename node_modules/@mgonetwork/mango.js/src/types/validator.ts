...
/* -------------- Types for the MgoSystemState Rust definition -------------- */
...
export const MgoSupplyFields = object({
	value: number(),
});
...
export const MgoValidatorSummary = object({
	mgoAddress: string(),
...
export const MgoSystemStateSummary = object({
	epoch: string(),
	...
	totalStake: string(),
	activeValidators: array(MgoValidatorSummary),
