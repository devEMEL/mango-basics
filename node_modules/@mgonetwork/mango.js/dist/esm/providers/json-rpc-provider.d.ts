...
import type { CheckpointDigest, ExecuteTransactionRequestType, MgoEvent, MgoEventFilter, MgoObjectDataOptions, MgoObjectResponseQuery, MgoTransactionBlockResponseOptions, MgoTransactionBlockResponseQuery, Order, TransactionEffects, TransactionFilter, Unsubscribe } from '../types/index.js';
import { Checkpoint, CoinBalance, CoinSupply, CommitteeInfo, DelegatedStake, DevInspectResults, DryRunTransactionBlockResponse, MgoMoveFunctionArgTypes, MgoMoveNormalizedFunction, MgoMoveNormalizedModule, MgoMoveNormalizedModules, MgoMoveNormalizedStruct, MgoObjectResponse, MgoSystemStateSummary, MgoTransactionBlockResponse, MoveCallMetrics, ObjectRead, PaginatedCoins, PaginatedEvents, PaginatedObjectsResponse, PaginatedTransactionResponse, ProtocolConfig, ResolvedNameServiceNames, ValidatorsApy } from '../types/index.js';
...
export declare class JsonRpcProvider {
    ...
    requestMgoFromFaucet(recipient: string, headers?: HttpHeaders): Promise<{
    ...
    getBalance(input: {
        owner: string;
        /** optional fully qualified type names for the coin (e.g., 0x168da5bf1f48dafc111b0a488fa454aca95e0b5e::usdc::USDC), default to 0x2::mgo::MGO if not specified. */
        coinType?: string | null;
    }): Promise<CoinBalance>;
    /**
    ...
    getMoveFunctionArgTypes(input: {
        ...
        module: string;
        function: string;
    }): Promise<MgoMoveFunctionArgTypes>;
    /**
    ...
    getNormalizedMoveModulesByPackage(input: {
        package: string;
    }): Promise<MgoMoveNormalizedModules>;
    /**
    ...
    getNormalizedMoveModule(input: {
        package: string;
        module: string;
    }): Promise<MgoMoveNormalizedModule>;
    /**
    ...
    getNormalizedMoveFunction(input: {
        ...
        module: string;
        function: string;
    }): Promise<MgoMoveNormalizedFunction>;
    /**
    ...
    getNormalizedMoveStruct(input: {
        ...
        module: string;
        struct: string;
    }): Promise<MgoMoveNormalizedStruct>;
    /**
     * Get all objects owned by an address
     */
    getOwnedObjects(input: {
        owner: string;
    } & PaginationArguments<PaginatedObjectsResponse['nextCursor']> & MgoObjectResponseQuery): Promise<PaginatedObjectsResponse>;
    /**
     ...
     */
    queryTransactionBlocks(input: MgoTransactionBlockResponseQuery & PaginationArguments<PaginatedTransactionResponse['nextCursor']> & OrderArguments): Promise<PaginatedTransactionResponse>;
    getTransactionBlock(input: {
        digest: string;
        options?: MgoTransactionBlockResponseOptions;
    }): Promise<MgoTransactionBlockResponse>;
    ...
    devInspectTransactionBlock(input: {
        ...
        sender: string;
        /** Default to use the network reference gas price stored in the Mgo System State object */
        gasPrice?: bigint | number | null;
        /** optional. Default to use the current epoch number stored in the Mgo System State object */
        epoch?: string | null;
    ...
    waitForTransactionBlock({ signal, timeout, pollInterval, ...input }: {
        ...
        pollInterval?: number;
    } & Parameters<JsonRpcProvider['getTransactionBlock']>[0]): Promise<MgoTransactionBlockResponse>;
}
