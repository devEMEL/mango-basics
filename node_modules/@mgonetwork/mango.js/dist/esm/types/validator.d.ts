...
export declare const StakeObject: import("superstruct").Struct<{
    ...
    stakedMgoId: import("superstruct").Struct<string, null>;
...
export declare const MgoSupplyFields: import("superstruct").Struct<{
    value: number;
}, {
    value: import("superstruct").Struct<number, null>;
}>;
...
export declare const DelegationStakingPoolFields: import("superstruct").Struct<{
    ...
    pendingTotalMgoWithdraw: number;
    ...
    pendingTotalMgoWithdraw: import("superstruct").Struct<number, null>;
    ...
    mgoBalance: import("superstruct").Struct<number, null>;
}>;
...
export declare const MgoValidatorSummary: import("superstruct").Struct<{
    description: string;
    name: string;
    pendingStake: string;
    ...
    mgoAddress: import("superstruct").Struct<string, null>;
    ...
    stakingPoolMgoBalance: import("superstruct").Struct<string, null>;
    ...
    pendingTotalMgoWithdraw: import("superstruct").Struct<string, null>;
    exchangeRatesId: import("superstruct").Struct<string, null>;
    exchangeRatesSize: import("superstruct").Struct<string, null>;
}>;
export type MgoValidatorSummary = Infer<typeof MgoValidatorSummary>;
export declare const MgoSystemStateSummary: import("superstruct").Struct<{
...
export type MgoSystemStateSummary = Infer<typeof MgoSystemStateSummary>;
