...
/**
 * Configuration options for the MgoClient
 * You must provide either a `url` or a `transport`
 */
export type MgoClientOptions = NetworkOrTransport;
export type NetworkOrTransport = {
    url: string;
    transport?: never;
} | {
    transport: MgoTransport;
    url?: never;
};
export declare const MGO_CLIENT_BRAND: unique symbol;
export declare function isMgoClient(client: unknown): client is MgoClient;
export declare class MgoClient {
    protected transport: MgoTransport;
    get [MGO_CLIENT_BRAND](): boolean;
    /**
     * Establish a connection to a Mgo RPC endpoint
     *
     * @param options configuration options for the API Client
     */
    constructor(options: MgoClientOptions);
     ...
     */
    getMoveFunctionArgTypes(input: GetMoveFunctionArgTypesParams): Promise<MgoMoveFunctionArgType[]>;
    /**
     * Get a map from module name to
     * structured representations of Move modules
     */
    getNormalizedMoveModulesByPackage(input: GetNormalizedMoveModulesByPackageParams): Promise<MgoMoveNormalizedModules>;
    /**
     * Get a structured representation of Move module
     */
    getNormalizedMoveModule(input: GetNormalizedMoveModuleParams): Promise<MgoMoveNormalizedModule>;
    /**
     * Get a structured representation of Move function
     */
    getNormalizedMoveFunction(input: GetNormalizedMoveFunctionParams): Promise<MgoMoveNormalizedFunction>;
    /**
     * Get a structured representation of Move struct
     */
    getNormalizedMoveStruct(input: GetNormalizedMoveStructParams): Promise<MgoMoveNormalizedStruct>;
    /**
     ...
     */
    getObject(input: GetObjectParams): Promise<MgoObjectResponse>;
    tryGetPastObject(input: TryGetPastObjectParams): Promise<ObjectRead>;
    /**
     * Batch get details about a list of objects. If any of the object ids are duplicates the call will fail
     */
    multiGetObjects(input: MultiGetObjectsParams): Promise<MgoObjectResponse[]>;
    /**
     * Get transaction blocks for a given query criteria
     */
    queryTransactionBlocks(input: QueryTransactionBlocksParams): Promise<PaginatedTransactionResponse>;
    getTransactionBlock(input: GetTransactionBlockParams): Promise<MgoTransactionBlockResponse>;
    multiGetTransactionBlocks(input: MultiGetTransactionBlocksParams): Promise<MgoTransactionBlockResponse[]>;
    executeTransactionBlock(input: ExecuteTransactionBlockParams): Promise<MgoTransactionBlockResponse>;
    signAndExecuteTransactionBlock({ transactionBlock, signer, ...input }: {
        transactionBlock: Uint8Array | TransactionBlock;
        signer: Keypair;
    } & Omit<ExecuteTransactionBlockParams, 'transactionBlock' | 'signature'>): Promise<MgoTransactionBlockResponse>;
    /**
     ...
     */
    getLatestMgoSystemState(): Promise<MgoSystemStateSummary>;
    /**
     ...
     */
    getDynamicFieldObject(input: GetDynamicFieldObjectParams): Promise<MgoObjectResponse>;
    /**
    ...
    waitForTransactionBlock({ signal, timeout, pollInterval, ...input }: {
        ...
        pollInterval?: number;
    } & Parameters<MgoClient['getTransactionBlock']>[0]): Promise<MgoTransactionBlockResponse>;
}
