...
export interface DevInspectResults {
    ...
    results?: MgoExecutionResult[] | null;
}
...
/**
 * Unique ID of a Mgo Event, the ID is a combination of tx seq number and event seq number, the ID is
...
export type InputObjectKind = {
    ...
    ImmOrOwnedMoveObject: MgoObjectRef;
} | {
    SharedMoveObject: {
        id: string;
...
export type MgoMoveFunctionArgType = 'Pure' | {
...
export interface MgoObjectData {
    /**
     * Move object content or package content in BCS, default to be None unless
     * MgoObjectDataOptions.showBcs is set to true
     */
    bcs?: RawData | null;
    /**
     * Move object content or package content, default to be None unless MgoObjectDataOptions.showContent
     * is set to true
     */
    content?: MgoParsedData | null;
    /** Base64 string representing the object digest */
    digest: string;
    /**
     * The Display metadata for frontend UI rendering, default to be None unless
     * MgoObjectDataOptions.showContent is set to true This can also be None if the struct type does not
     * have Display defined See more details in <https://forums.mgo.io/t/nft-object-display-proposal/4872>
     */
    ...
    /**
     * The amount of MGO we would rebate if this object gets deleted. This number is re-calculated each
...
export interface MgoObjectDataOptions {
...
export interface MgoObjectResponseQuery {
    /** If None, no filter will be applied */
    filter?: MgoObjectDataFilter | null;
    /** config which fields to include in the response, by default only digest is included */
    options?: MgoObjectDataOptions | null;
}
...
* MgoAddress as MgoAddress is universal.
*/ | {
    ObjectOwner: string;
...
export type Signature = {
    Ed25519MgoSignature: string;
} | {
    Secp256k1MgoSignature: string;
} | {
    Secp256r1MgoSignature: string;
};
...
export interface MgoActiveJwk {
    epoch: string;
    jwk: MgoJWK;
    jwk_id: MgoJwkId;
}
/** An argument to a transaction in a programmable transaction block */
export type MgoArgument = 'GasCoin' /** One of the input objects or primitive values (from `ProgrammableTransactionBlock` inputs) */ | {
    Input: number;
...
export interface MgoExecutionResult {
    /** The value of any arguments that were mutably borrowed. Non-mut borrowed values are not included */
    mutableReferenceOutputs?: [MgoArgument, number[], string][];
    /** The return values from the transaction */
    returnValues?: [number[], string][];
}
export interface MgoJWK {
    alg: string;
    e: string;
    kty: string;
    n: string;
}
export interface MgoJwkId {
    iss: string;
    kid: string;
}
export type MgoMoveAbility = 'Copy' | 'Drop' | 'Store' | 'Key';
export interface MgoMoveAbilitySet {
    abilities: MgoMoveAbility[];
}
export interface MgoMoveModuleId {
    address: string;
    name: string;
}
export interface MgoMoveNormalizedField {
    name: string;
    type: MgoMoveNormalizedType;
}
export interface MgoMoveNormalizedFunction {
    isEntry: boolean;
    parameters: MgoMoveNormalizedType[];
    return: MgoMoveNormalizedType[];
    typeParameters: MgoMoveAbilitySet[];
    visibility: MgoMoveVisibility;
}
export interface MgoMoveNormalizedModule {
    address: string;
    exposedFunctions: {
        [key: string]: MgoMoveNormalizedFunction;
    };
    fileFormatVersion: number;
    friends: MgoMoveModuleId[];
    name: string;
    structs: {
        [key: string]: MgoMoveNormalizedStruct;
    };
}
export interface MgoMoveNormalizedStruct {
    abilities: MgoMoveAbilitySet;
    fields: MgoMoveNormalizedField[];
    typeParameters: MgoMoveStructTypeParameter[];
}
export type MgoMoveNormalizedType = 'Bool' | 'U8' | 'U16' | 'U32' | 'U64' | 'U128' | 'U256' | 'Address' | 'Signer' | {
    Struct: {
        address: string;
        module: string;
        name: string;
...
export interface MgoMoveStructTypeParameter {
    constraints: MgoMoveAbilitySet;
    isPhantom: boolean;
}
export type MgoMoveVisibility = 'Private' | 'Public' | 'Friend';
...
export interface MgoObjectResponse {
    data?: MgoObjectData | null;
    error?: ObjectResponseError | null;
}
/**
 ...
 */
export interface MoveCallMgoTransaction {
    /** The arguments to the function. */
    arguments?: MgoArgument[];
...
/**
 * This is the JSON-RPC type for the MGO system state object. It flattens all fields to make them
 * top-level fields such that it as minimum dependencies to the internal data structures of the MGO
 * system state type.
 */
export interface MgoSystemStateSummary {
    /** The list of active validators in the current epoch. */
    activeValidators: MgoValidatorSummary[];
    ...
    /** ID of the object that maps from staking pool's ID to the mgo address of a validator. */
...
{
    MoveCall: MoveCallMgoTransaction;
} /**
...
*/ | {
    ...
    Upgrade: [string[], string, MgoArgument];
} /**
...
*/ | {
    MakeMoveVec: [string | null, MgoArgument[]];
};
export type MgoTransactionBlockBuilderMode = 'Commit' | 'DevInspect';
/**
 * This is the JSON-RPC type for the MGO validator. It flattens all inner structures to top-level
 * fields so that they are decoupled from the internal definitions.
 */
export interface MgoValidatorSummary {
    ...
    pendingTotalMgoWithdraw: string;
    ...
    /** The total number of MGO tokens in this pool. */
    stakingPoolMgoBalance: string;
    mgoAddress: string;
    votingPower: string;
...
export interface MgoTransactionBlock {
...
/** The response from processing a transaction or a certified transaction */
{
    ...
    unwrappedThenDeleted?: MgoObjectRef[];
    /** Object refs of objects now wrapped in other objects. */
    wrapped?: MgoObjectRef[];
};
export interface TransactionBlockEffectsModifiedAtVersions {
    objectId: string;
    sequenceNumber: string;
}
export type MgoTransactionBlockKind = 
/** A system transaction that will update epoch information on-chain. */
{
    ...
    new_active_jwks: MgoActiveJwk[];
    round: string;
};
export interface MgoTransactionBlockResponse {
    ...
    errors?: string[];
    events?: MgoEvent[] | null;
    objectChanges?: MgoObjectChange[] | null;
    /**
    ...
    transaction?: MgoTransactionBlock | null;
}
export interface MgoTransactionBlockResponseOptions {
...
export interface MgoTransactionBlockResponseQuery {
    /** If None, no filter will be applied */
    filter?: TransactionFilter | null;
    /** config which fields to include in the response, by default only digest is included */
    options?: MgoTransactionBlockResponseOptions | null;
}
