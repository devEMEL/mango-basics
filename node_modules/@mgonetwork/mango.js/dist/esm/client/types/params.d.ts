...
export interface ExecuteTransactionBlockParams {
    ...
    options?: RpcTypes.MgoTransactionBlockResponseOptions | null | undefined;
...
export interface GetObjectParams {
    ...
    id: string;
    /** options for specifying the content to be returned */
    options?: RpcTypes.MgoObjectDataOptions | null | undefined;
}
/**
...
export interface GetBalanceParams {
     ...
     * default to 0x2::mgo::MGO if not specified.
     */
...
export interface GetLatestMgoSystemStateParams {
}
/**
 ...
 * been updated when the next page is fetched. Please use mgox_queryObjects if this is a concern.
 */
export type GetOwnedObjectsParams = {
    ...
    limit?: number | null | undefined;
} & RpcTypes.MgoObjectResponseQuery;
...
export interface QueryEventsParams {
    /**
     * The event query criteria. See [Event filter](https://docs.mgo.io/build/event_api#event-filters)
     * documentation for examples.
     */
    query: RpcTypes.MgoEventFilter;
    /** optional paging cursor */
...
export type QueryTransactionBlocksParams = {
    ...
    /** query result ordering, default to false (ascending order), oldest record first. */
    order?: 'ascending' | 'descending' | null | undefined;
} & RpcTypes.MgoTransactionBlockResponseQuery;
...
export interface SubscribeEventParams {
     ...
     * [Event filter](https://docs.mgo.io/build/event_api#event-filters) documentation for examples.
     */
    filter: RpcTypes.MgoEventFilter;
}
...
export interface UnsafeBatchTransactionParams {
    ...
    txnBuilderMode?: RpcTypes.MgoTransactionBlockBuilderMode | null | undefined;
}
...
export interface UnsafeMoveCallParams {
    ...
    /**
     * the arguments to be passed into the Move function, in [MgoJson](https://docs.mgo.io/build/mgo-json)
     * format
     */
    arguments: unknown[];
    /**
     ...
     * `MgoTransactionBlockBuilderMode::Commit` when it's None.
     */
    executionMode?: RpcTypes.MgoTransactionBlockBuilderMode | null | undefined;
}
/**
...
export interface UnsafePayParams {
    /** the transaction signer's Mgo address */
    signer: string;
    /** the Mgo coins to be used in this transaction */
    inputCoins: string[];
...
/**
 * Send all MGO coins to one recipient. This is for MGO coin only and does not require a separate gas
 * coin object. Specifically, what pay_all_mgo does are: 1. accumulate all MGO from input coins and
 * deposit all MGO to the first input coin 2. transfer the updated first coin to the recipient and also
 ...
 */
export interface UnsafePayAllMgoParams {
    /** the transaction signer's Mgo address */
    signer: string;
    /** the Mgo coins to be used in this transaction, including the coin for gas payment. */
    inputCoins: string[];
...
/**
 * Send MGO coins to a list of addresses, following a list of amounts. This is for MGO coin only and
 * does not require a separate gas coin object. Specifically, what pay_mgo does are: 1. debit each
 * input_coin to create new coin following the order of amounts and assign it to the corresponding
 * recipient. 2. accumulate all residual MGO from input coins left and deposit all MGO to the first
 ...
 */
export interface UnsafePayMgoParams {
    /** the transaction signer's Mgo address */
    signer: string;
    /** the Mgo coins to be used in this transaction, including the coin for gas payment. */
    inputCoins: string[];
...
export interface UnsafeTransferObjectParams {
    ...
    /** the gas budget, the transaction will fail if the gas cost exceed the budget */
    gasBudget: string;
    /** the recipient's Mgo address */
    recipient: string;
}
/**
 * Create an unsigned transaction to send MGO coin object to a Mgo address. The MGO object is also used
 * as the gas object.
 */
export interface UnsafeTransferMgoParams {
    /** the transaction signer's Mgo address */
    signer: string;
    /** the Mgo coin object to be used in this transaction */
    mgoObjectId: string;
    /** the gas budget, the transaction will fail if the gas cost exceed the budget */
    gasBudget: string;
    /** the recipient's Mgo address */
