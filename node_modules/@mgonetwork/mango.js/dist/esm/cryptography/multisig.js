...
import { normalizeMgoAddress } from "../utils/mgo-types.js";
import { SIGNATURE_SCHEME_TO_FLAG } from "./signature-scheme.js";
import { toSingleSignaturePubkeyPair } from "./utils.js";
import { MAX_SIGNER_IN_MULTISIG as MAX_SIGNER_IN_MULTISIG2, MIN_SIGNER_IN_MULTISIG as MIN_SIGNER_IN_MULTISIG2 } from "../multisig/publickey.js";
function toMultiSigAddress(pks, threshold) {
  ...
  return normalizeMgoAddress(bytesToHex(keccak_256(tmp.slice(0, i))));
}
...
export {
  MAX_SIGNER_IN_MULTISIG2 as MAX_SIGNER_IN_MULTISIG,
  MIN_SIGNER_IN_MULTISIG2 as MIN_SIGNER_IN_MULTISIG,
  combinePartialSigs,
  decodeMultiSig,
  toMultiSigAddress
};
