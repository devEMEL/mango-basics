...
import type { DevInspectResults, DryRunTransactionBlockResponse, ExecuteTransactionRequestType, MgoClient, MgoTransactionBlockResponse, MgoTransactionBlockResponseOptions } from '../client/index.js';
...
export declare abstract class SignerWithProvider implements Signer {
     ...
     */
    requestMgoFromFaucet(httpHeaders?: HttpHeaders): Promise<{
