...
var import_bcs = require("@mgonetwork/bcs");
...
class JsonRpcProvider {
  ...
  /** @deprecated Use `@mgonetwork/mgo.js/faucet` instead. */
  async requestMgoFromFaucet(recipient, headers) {
    if (!this.connection.faucet) {
      throw new Error("Faucet URL is not specified");
    }
    return (0, import_faucet.requestMgoFromFaucetV0)({ host: this.connection.faucet, recipient, headers });
  }
  /**
   * Get all Coin<`coin_type`> objects owned by an address.
   */
  async getCoins(input) {
    if (!input.owner || !(0, import_mgo_types.isValidMgoAddress)((0, import_mgo_types.normalizeMgoAddress)(input.owner))) {
  ...
  async getTotalSupply(input) {
    return await this.client.requestWithType("mgox_getTotalSupply", [input.coinType], import_types.CoinSupply);
  }
  /**
  ...
  async getMoveFunctionArgTypes(input) {
    return await this.client.requestWithType(
      ...
      import_types.MgoMoveFunctionArgTypes
    );
  }
  /**
  ...
  async getNormalizedMoveModulesByPackage(input) {
    return await this.client.requestWithType(
      ...
      [input.package],
      import_types.MgoMoveNormalizedModules
    );
  }
  /**
  ...
  async getNormalizedMoveModule(input) {
    return await this.client.requestWithType(
      ...
      import_types.MgoMoveNormalizedModule
    );
  }
  /**
  ...
  async getNormalizedMoveFunction(input) {
    return await this.client.requestWithType(
      ...
      [input.package, input.module, input.function],
      import_types.MgoMoveNormalizedFunction
    );
  }
  /**
  ...
  async getNormalizedMoveStruct(input) {
    return await this.client.requestWithType(
      ...
      import_types.MgoMoveNormalizedStruct
    );
  }
  /**
  ...
  async getObject(input) {
    if (!input.id || !(0, import_mgo_types.isValidMgoObjectId)((0, import_mgo_types.normalizeMgoObjectId)(input.id))) {
      throw new Error("Invalid Mgo Object id");
    }
    return await this.client.requestWithType(
      "mgo_getObject",
      [input.id, input.options],
      import_types.MgoObjectResponse
    );
  }
  async tryGetPastObject(input) {
    return await this.client.requestWithType(
      "mgo_tryGetPastObject",
  ...
  async multiGetObjects(input) {
    input.ids.forEach((id) => {
      if (!id || !(0, import_mgo_types.isValidMgoObjectId)((0, import_mgo_types.normalizeMgoObjectId)(id))) {
    ...
    return await this.client.requestWithType(
      ...
      (0, import_superstruct.array)(import_types.MgoObjectResponse)
    );
  }
  /**
  ...
  async getTransactionBlock(input) {
    if (!(0, import_mgo_types.isValidTransactionDigest)(input.digest)) {
      throw new Error("Invalid Transaction digest");
    }
    return await this.client.requestWithType(
      "mgo_getTransactionBlock",
      [input.digest, input.options],
      import_types.MgoTransactionBlockResponse
    );
  }
  async multiGetTransactionBlocks(input) {
    input.digests.forEach((d) => {
      if (!(0, import_mgo_types.isValidTransactionDigest)(d)) {
    ...
    return await this.client.requestWithType(
      "mgo_multiGetTransactionBlocks",
      [input.digests, input.options],
      (0, import_superstruct.array)(import_types.MgoTransactionBlockResponse)
    );
  }
  ...
  async getTotalTransactionBlocks() {
    const resp = await this.client.requestWithType("mgo_getTotalTransactionBlocks", [], (0, import_superstruct.string)());
    return BigInt(resp);
  }
  /**
  ...
  async getReferenceGasPrice() {
    const resp = await this.client.requestWithType("mgox_getReferenceGasPrice", [], (0, import_superstruct.string)());
    return BigInt(resp);
  }
  /**
  ...
  async getLatestMgoSystemState() {
    return await this.client.requestWithType(
      ...
      [],
      import_types.MgoSystemStateSummary
    );
  }
  /**
  ...
  async getDynamicFields(input) {
    if (!input.parentId || !(0, import_mgo_types.isValidMgoObjectId)((0, import_mgo_types.normalizeMgoObjectId)(input.parentId))) {
      throw new Error("Invalid Mgo Object id");
    }
    return await this.client.requestWithType(
      "mgox_getDynamicFields",
  ...
  async getCheckpoint(input) {
    return await this.client.requestWithType("mgo_getCheckpoint", [input.id], import_types.Checkpoint);
  }
  /**
  ...
  async getCommitteeInfo(input) {
    return await this.client.requestWithType(
      "mgox_getCommitteeInfo",
      [input?.epoch],
      import_types.CommitteeInfo
    );
  }
  async getNetworkMetrics() {
    return await this.client.requestWithType("mgox_getNetworkMetrics", [], import_metrics.NetworkMetrics);
  }
  async getAddressMetrics() {
    return await this.client.requestWithType("mgox_getLatestAddressMetrics", [], import_metrics.AddressMetrics);
  }
  async getAllEpochAddressMetrics(input) {
    return await this.client.requestWithType(
      "mgox_getAllEpochAddressMetrics",
  ...
  async getMoveCallMetrics() {
    return await this.client.requestWithType("mgox_getMoveCallMetrics", [], import_types.MoveCallMetrics);
  }
  /**
   * Return the committee information for the asked epoch
   */
  async getCurrentEpoch() {
    return await this.client.requestWithType("mgox_getCurrentEpoch", [], import_epochs.EpochInfo);
  }
  /**
   * Return the Validators APYs
   */
  async getValidatorsApy() {
    return await this.client.requestWithType("mgox_getValidatorsApy", [], import_types.ValidatorsApy);
  }
  ...
  async resolveNameServiceAddress(input) {
    return await this.client.requestWithType(
      "mgox_resolveNameServiceAddress",
      [input.name],
