...
const DEFAULT_SECP256R1_DERIVATION_PATH = "m/74'/938'/0'/0/0";
class Secp256r1Keypair extends import_keypair.Keypair {
  ...
  static fromSecretKey(secretKey, options) {
    ...
    if (!options || !options.skipValidation) {
      ...
      const signData = encoder.encode("mgo validation");
      const msgHash = (0, import_utils.bytesToHex)((0, import_sha3.keccak_256)(signData));
   ...
   */
  getSecretKey() {
    return (0, import_keypair.encodeMgoPrivateKey)(this.keypair.secretKey, this.getKeyScheme());
  }
  async sign(data) {
   ...
   *
   * If path is none, it will default to m/74'/938'/0'/0/0, otherwise the path must
   * be compliant to BIP-32 in form m/74'/938'/{account_index}'/{change_index}/{address_index}.
   */
