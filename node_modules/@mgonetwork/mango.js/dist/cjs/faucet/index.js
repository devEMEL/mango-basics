...
__export(faucet_exports, {
  ...
  requestMgoFromFaucetV0: () => requestMgoFromFaucetV0,
  requestMgoFromFaucetV1: () => requestMgoFromFaucetV1
});
...
async function requestMgoFromFaucetV0(input) {
...
async function requestMgoFromFaucetV1(input) {
  return faucetRequest({
    host: input.host,
    path: "/v1/gas",
    body: {
...
function getFaucetHost(network) {
  switch (network) {
    case "testnet":
      return "https://faucet.testnet.mangonetwork.io";
    case "devnet":
      return "https://faucet.devnet.mangonetwork.io";
    case "localnet":
