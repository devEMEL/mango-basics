...
/** @deprecated Use `string` instead. */
export declare const MgoAddress: import("superstruct").Struct<string, null>;
/** @deprecated Use `string` instead. */
export type MgoAddress = Infer<typeof MgoAddress>;
/** @deprecated Use `string` instead. */
...
export type MgoJsonValue = boolean | number | string | CallArg | Array<MgoJsonValue>;
export declare const MgoJsonValue: import("superstruct").Struct<MgoJsonValue, null>;
