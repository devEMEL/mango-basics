...
export declare const MgoEvent: import("superstruct").Struct<{
    id: {
        txDigest: string;
        eventSeq: string;
    };
...
export declare function getEventSender(event: MgoEvent): string;
export declare function getEventPackage(event: MgoEvent): string;
