...
__export(validator_exports, {
  ...
  MgoSupplyFields: () => MgoSupplyFields,
  MgoSystemStateSummary: () => MgoSystemStateSummary,
  MgoValidatorSummary: () => MgoValidatorSummary,
...
const StakeObject = (0, import_superstruct.object)({
  stakedMgoId: (0, import_superstruct.string)(),
...
const MgoSupplyFields = (0, import_superstruct.object)({
  value: (0, import_superstruct.number)()
});
...
const DelegationStakingPoolFields = (0, import_superstruct.object)({
  ...
  pendingTotalMgoWithdraw: (0, import_superstruct.number)(),
  ...
  mgoBalance: (0, import_superstruct.number)()
});
...
const MgoValidatorSummary = (0, import_superstruct.object)({
  mgoAddress: (0, import_superstruct.string)(),
  ...
  stakingPoolMgoBalance: (0, import_superstruct.string)(),
  ...
  pendingTotalMgoWithdraw: (0, import_superstruct.string)(),
  exchangeRatesId: (0, import_superstruct.string)(),
  exchangeRatesSize: (0, import_superstruct.string)()
});
const MgoSystemStateSummary = (0, import_superstruct.object)({
  epoch: (0, import_superstruct.string)(),
  ...
  activeValidators: (0, import_superstruct.array)(MgoValidatorSummary),
