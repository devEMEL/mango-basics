...
const ObjectArg = (0, import_superstruct.union)([
  (0, import_superstruct.object)({ ImmOrOwned: import_types.MgoObjectRef }),
    ...
    return {
      Object: {
        ImmOrOwned: {
          digest,
          version,
          objectId: (0, import_mgo_types.normalizeMgoAddress)(objectId)
        }
      }
    };
  },
...
function getIdFromCallArg(arg) {
  if (typeof arg === "string") {
    return (0, import_mgo_types.normalizeMgoAddress)(arg);
  }
  if ("ImmOrOwned" in arg.Object) {
    return (0, import_mgo_types.normalizeMgoAddress)(arg.Object.ImmOrOwned.objectId);
  }
  return (0, import_mgo_types.normalizeMgoAddress)(arg.Object.Shared.objectId);
}
