...
builder.registerType(
  ...
  function encodeProgrammableTx(writer, data, typeParams, typeMap) {
    ...
    const type_arguments = data.typeArguments.map(
      (tag) => import_bcs2.TypeTagSerializer.parseFromStr(tag, true)
    );
    return this.getTypeInterface(PROGRAMMABLE_CALL_INNER)._encodeRaw.call(
      this,
      writer,
      {
        package: (0, import_mgo_types.normalizeMgoAddress)(pkg),
        module: module2,
        function: fun,
        type_arguments,
  ...
  function decodeProgrammableTx(reader, typeParams, typeMap) {
    ...
    return {
      ...
      arguments: data.arguments,
      typeArguments: data.type_arguments.map(import_bcs2.TypeTagSerializer.tagToString)
    };
  },
