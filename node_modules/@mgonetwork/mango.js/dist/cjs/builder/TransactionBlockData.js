...
const GasConfig = (0, import_superstruct.object)({
  ...
  payment: (0, import_superstruct.optional)((0, import_superstruct.array)(import_types.MgoObjectRef)),
...
function prepareMgoAddress(address) {
  return (0, import_mgo_types.normalizeMgoAddress)(address).replace("0x", "");
}
class TransactionBlockDataBuilder {
  ...
  build({
    ...
    const transactionData = {
      sender: prepareMgoAddress(sender),
      expiration: expiration ? expiration : { None: true },
      gasData: {
        payment: gasConfig.payment,
        owner: prepareMgoAddress(this.gasConfig.owner ?? sender),
