...
import type { MgoMoveObject, MgoObjectData, MgoObjectInfo, MgoObjectResponse } from '../types/objects.js';
import type { Option } from '../types/option.js';
export declare const MGO_SYSTEM_ADDRESS = "0x3";
export declare const MGO_FRAMEWORK_ADDRESS = "0x2";
...
export declare function isObjectDataFull(resp: ObjectData | ObjectDataFull): resp is MgoObjectResponse;
...
export declare class Coin {
    ...
    static isMGO(obj: ObjectData): boolean;
...
export declare class Delegation {
    static readonly MGO_OBJECT_TYPE = "0x2::delegation::Delegation";
    private mgoObject;
    static isDelegationMgoObject(obj: MgoObjectData): obj is DelegationMgoObject;
