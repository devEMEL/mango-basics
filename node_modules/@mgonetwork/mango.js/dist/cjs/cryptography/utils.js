...
var import_keypair3 = require("../keypairs/secp256r1/keypair.js");
var import_publickey3 = require("../keypairs/secp256r1/publickey.js");
var import_keypair4 = require("./keypair.js");
...
function publicKeyFromSerialized(schema, pubKey) {
  if (schema === "ED25519") {
    return new import_publickey.Ed25519PublicKey(pubKey);
  }
  if (schema === "Secp256k1") {
    return new import_publickey2.Secp256k1PublicKey(pubKey);
  }
  if (schema === "Secp256r1") {
    return new import_publickey3.Secp256r1PublicKey(pubKey);
  }
...
function fromExportedKeypair(keypair) {
  ...
  switch (keypair.schema) {
    case "ED25519":
      ...
      if (secretKey.length === import_keypair4.LEGACY_PRIVATE_KEY_SIZE) {
        pureSecretKey = secretKey.slice(0, import_keypair4.PRIVATE_KEY_SIZE);
      }
    ...
    case "Secp256r1":
      return import_keypair3.Secp256r1Keypair.fromSecretKey(secretKey);
    default:
