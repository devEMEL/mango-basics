...
class PublicKey {
  ...
  verifyWithIntent(bytes, signature, intent) {
    ...
    const digest = (0, import_sha3.keccak_256)(intentMessage);
  ...
  verifyPersonalMessage(message, signature) {
    return this.verifyWithIntent(
      import_bcs2.bcs.ser(["vector", "u8"], message).toBytes(),
      signature,
   ...
   */
  toMgoAddress() {
    return (0, import_mgo_types.normalizeMgoAddress)(
      (0, import_utils.bytesToHex)((0, import_sha3.keccak_256)(this.toMgoBytes())).slice(0, import_mgo_types.MGO_ADDRESS_LENGTH * 2)
    );
  }
}
